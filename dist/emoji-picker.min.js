...
s.trimmer=function(e){return e.replace(/^\W+/,"").replace(/\W+$/,"")},s.Pipeline.registerFunction(s.trimmer,"trimmer"),/*!
	 ...
	 * Includes code from - http://tartarus.org/~martin/PorterStemmer/js.txt
	 */
s.TokenStore=function(){this.root={docs:{}},this.length=0},s.TokenStore.load=function(e){var o=new this;return o.root=e.root,o.length=e.length,o},s.TokenStore.prototype.add=function(e,o,a){var a=a||this.root,i=e.charAt(0),t=e.slice(1);return i in a||(a[i]={docs:{}}),0===t.length?(a[i].docs[o.ref]=o,void(this.length+=1)):this.add(t,o,a[i])},s.TokenStore.prototype.has=function(e){if(!e)return!1;for(var o=this.root,a=0;a<e.length;a++){if(!o[e.charAt(a)])return!1;o=o[e.charAt(a)]}return!0},s.TokenStore.prototype.getNode=function(e){if(!e)return{};for(var o=this.root,a=0;a<e.length;a++){if(!o[e.charAt(a)])return{};o=o[e.charAt(a)]}return o},s.TokenStore.prototype.get=function(e,o){return this.getNode(e,o).docs||{}},s.TokenStore.prototype.count=function(e,o){return Object.keys(this.get(e,o)).length},s.TokenStore.prototype.remove=function(e,o){if(e){for(var a=this.root,i=0;i<e.length;i++){if(!(e.charAt(i)in a))return;a=a[e.charAt(i)]}delete a.docs[o]}},s.TokenStore.prototype.expand=function(e,o){var a=this.getNode(e),i=a.docs||{},o=o||[];return Object.keys(i).length&&o.push(e),Object.keys(a).forEach(function(a){"docs"!==a&&o.concat(this.expand(e+a,o))},this),o},s.TokenStore.prototype.toJSON=function(){return{root:this.root,length:this.length}},function(s,_){i=_,t="function"==typeof i?i.call(o,a,o,e):i,!(void 0!==t&&(e.exports=t))}(this,function(){return s})}()},function(e,o,a){"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}function t(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}function s(e,o){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!o||"object"!=typeof o&&"function"!=typeof o?e:o}function _(e,o){if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function, not "+typeof o);e.prototype=Object.create(o&&o.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),o&&(Object.setPrototypeOf?Object.setPrototypeOf(e,o):e.__proto__=o)}Object.defineProperty(o,"__esModule",{value:!0});var n=function(){function e(e,o){for(var a=0;a<o.length;a++){var i=o[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(o,a,i){return a&&e(o.prototype,a),i&&e(o,i),o}}(),g=a(3),m=i(g),r=function(e){function o(e){t(this,o);var a=s(this,Object.getPrototypeOf(o).call(this,e));return a.state={opened:!1},a}return _(o,e),n(o,[{key:"handleClick",value:function(e){var o=this.props.onChange;this.state.opened?(o(e),this.setState({opened:!1})):this.setState({opened:!0})}},{key:"render",value:function(){var e=this,o=this.props.skin,a=this.state.opened;return m["default"].createElement("div",null,m["default"].createElement("div",{className:"emoji-picker-skin-swatches "+(a?"emoji-picker-skin-swatches-opened":"")},Array(6).fill().map(function(a,i){var t=i+1,s=t==o;return m["default"].createElement("span",{key:"skin-tone-"+t,className:"emoji-picker-skin-swatch "+(s?"emoji-picker-skin-swatch-selected":"")},m["default"].createElement("span",{onClick:function(){return e.handleClick(t)},className:"emoji-picker-skin emoji-picker-skin-tone-"+t}))})))}}]),o}(m["default"].Component);o["default"]=r,r.propTypes={onChange:m["default"].PropTypes.func,skin:m["default"].PropTypes.number.isRequired},r.defaultProps={onChange:function(){}}}])});